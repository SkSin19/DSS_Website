...
export function SkeletonHero() {
  return (
    <section className="w-full min-h-[600px] bg-gray-100 flex items-center" aria-hidden="true">
...
export function SkeletonCategoryCard() {
  return (
    <div className="bg-gray-100 rounded-2xl p-8 space-y-4" aria-hidden="true">
...
export function SkeletonPage() {
  return (
    <div className="min-h-screen" aria-label="Loading page content" role="status">
      <span className="sr-only">Loading...</span>
      {/* Navbar skeleton */}
      <div className="h-16 bg-white border-b border-gray-100 flex items-center px-6 gap-8">
      ...
      {/* Marquee skeleton */}
      <div className="h-20 bg-white flex items-center justify-center gap-12 px-8 overflow-hidden">
      ...
      {/* Categories skeleton */}
      <div className="bg-gray-900 section-padding">
