...
export default function Navbar() {
  ...
  return (
    <header
      id="site-header"
      className={`sticky top-0 z-50 w-full bg-gray-200/30 backdrop-blur-3xl text-gray-900 transition-all select-none duration-300 border-b border-gray-300 overflow-visible ${
