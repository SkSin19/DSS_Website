...
function PremiumIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-sky-500 mb-2">
...
function DiamondIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-sky-500 mb-2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.99 3.75L4.5 10.5l7.49 9.75 7.51-9.75-7.51-6.75zM4.5 10.5h15" />
    </svg>
  );
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-[#2b354e] rounded-[2rem] p-8 min-h-[400px] lg:min-h-[500px] relative overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20 pointer-events-none">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1} className="w-64 h-64 text-sky-400">
          ...
          <div className="bg-[#f8f9fc] rounded-[2rem] p-10 md:p-16 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-6 mb-12">
              <div className="flex flex-col items-center sm:items-start text-center sm:text-left min-w-[80px]">
                <DiamondIcon />
                <span className="text-xs font-semibold text-gray-800 leading-tight">Premium<br/>Quality</span>
              </div>
              <div className="flex flex-col items-center sm:items-start text-center sm:text-left min-w-[80px]">
                <ShieldIcon />
                <span className="text-xs font-semibold text-gray-800 leading-tight">Reliable<br/>Protection</span>
              </div>
              <div className="flex flex-col items-center sm:items-start text-center sm:text-left min-w-[80px]">
                <SmartIcon />
                <span className="text-xs font-semibold text-gray-800 leading-tight">Smart<br/>Solutions</span>
              </div>
              <div className="flex flex-col items-center sm:items-start text-center sm:text-left min-w-[80px]">
                <SupportIcon />
                <span className="text-xs font-semibold text-gray-800 leading-tight">Dedicated<br/>Support</span>
              </div>
            </div>
            ...
            <div>
              <Link 
                href="/about" 
                className="inline-flex items-center justify-center bg-gray-900 text-white hover:bg-black px-8 py-3.5 rounded-full text-sm font-semibold transition-colors gap-2 group shadow-xl"
              >
                Read our Story
